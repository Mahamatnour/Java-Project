...
public class Car {
    ...
    public CarTab searchEntry;

    public Car() {
        searchEntry = new CarTab();
    }

    public CarRegister getAddEntry() {
        return addEntry;
    }

    public void setAddEntry(CarRegister addEntry) {
    ...
    public CarRegister addEntry = new CarRegister();
    ...
    public BorderPane getNode(Home home, boolean admin) {
        ...
        update.setOnAction((ActionEvent event) -> {
            ...
            home.feneter.setScene(new CarRegister().getScene(home,this,true));//set the update scene
